...
async def root() -> dict[str, Any]:
    ...
    return {
        ...
        "note": "Set VLA_MODEL=exp49 for goal-navigation backend (96.4% acc, 100% CL).",
    }
...
if __name__ == "__main__":
    ...
    logger.info("Pre-loading model (VLA_MODEL=%s) before server start...", vla_model)
    get_model()
    logger.info("Model ready (%s). Starting uvicorn...", vla_model)
