...
1. [docs/AGENT_ENTRYPOINT.md](/home/billy/25-1kp/MoNaVLA/docs/AGENT_ENTRYPOINT.md:1)
2. 이 문서
...
| Claude project memory | `~/.claude_MINU/projects/-home-billy-25-1kp-MoNaVLA/memory/` | 사용자 선호, 작업 규칙, 프로젝트 상태 | 프로젝트 격리 |
...
- Claude project memory의 `project_monavla.md` 는 현재 브랜치 진행보다 오래된
  상태일 수 있다.
- Antigravity의 실제 복구 소스는 `~/.gemini/antigravity/` 이며,
